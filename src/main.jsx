...
import './index.css'
import { Background, Catalog, Blog, Login, Post1, Post2, Post3, Register, Assistance, Shopping } from './components'
  ...
  <StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/shopping" element={<DynamicPage componentName="shopping" />} />
      </Routes>
    </BrowserRouter>
  </StrictMode>,
)